...
if ( array_filter( $contact_details ) ) : ?>
	...
	<p><?php _e( 'We welcome your feedback on the accessibility of', 'a11y-statement' ); ?> <?php echo $website_name; ?><?php _e( '.', 'a11y-statement' ); ?> <?php _e( 'Please let us know if you encounter accessibility barriers on', 'a11y-statement' ); ?> <?php echo $website_name; ?>:</p>
	...
	<?php if ( $feedback_time ) : ?>
		<p><?php _e( 'We try to respond to feedback within', 'a11y-statement' ); ?> <?php echo $feedback_time; ?><?php _e( '.', 'a11y-statement' ); ?></p>
	<?php endif; ?>
<?php endif; ?>
